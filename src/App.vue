...
<div class="heart" @mouseover="isActive = false"
  @mouseout="isActive = false" v-bind:class="{is_animating: isActive}" v-on="{click: greet}" ></div>
    <!--<img src="http://app.designqube.com/img/home_logo.png">
    <h1>{{ msg }}</h1>
    <div class="heart" @mouseover="isActive = false"
      @mouseout="isActive = false" v-bind:class="{is_animating: isActive}" v-on="{click: greet}" ></div>
    <h2> Links</h2>
